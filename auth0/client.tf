resource "auth0_client" "tfer--0cWWdpGt4CpWjHJ9QIHtPm5GrJLS25lz_Dreamkast-0020-UI-0020---0020-Review" {
  ...
  callbacks = [
    ...
    "http://localhost:3001/cndw2025/ui",
    "https://*.dev.cloudnativedays.jp/cndw2025/ui",
  ]
...
resource "auth0_client" "tfer--JxqrUDloZhPPWKflAQXlmPJgxrI1d5ms_Dreamkast-0020-UI" {
  ...
  app_type            = "spa"
  callbacks = [
    "https://event.cloudnativedays.jp/cndw2025/ui",
  ]
  cross_origin_auth                   = "false"
  custom_login_page_on                = "true"
  grant_types                         = ["authorization_code", "refresh_token"]
...
resource "auth0_client" "tfer--TPeiKSZzmH2JZJPybE290kypTUrWClTk_Dreamkast-0020-UI-0020---0020-Staging" {
  ...
  app_type            = "spa"
  callbacks = [
    "https://staging.dev.cloudnativedays.jp/cndw2025/ui", "http://localhost:3001/cndw2025/ui",
  ]
  cross_origin_auth                   = "false"
  custom_login_page_on                = "true"
  grant_types                         = ["authorization_code", "refresh_token"]
  ...
  sso_disabled               = "false"
  token_endpoint_auth_method = "none"
  web_origins                = ["http://localhost:3001/cndw2025/ui", "https://staging.dev.cloudnativedays.jp"]
}
...
resource "auth0_client" "tfer--lIrIGrhacjYsZcqEXeauzTmkK5Sz79nL_Cloud-0020-Native-0020-Days-0020---0020--0020-Review" {
  allowed_logout_urls                 = ["http://*.dev.cloudnativedays.jp/", "http://127.0.0.1:3000/", "http://127.0.0.2:3000/", "http://localhost:3000/", "http://localhost:8080/", "https://*.dev.cloudnativedays.jp/"]
  app_type                            = "regular_web"
  callbacks                           = ["http://*.dev.cloudnativedays.jp/auth/auth0/callback", "http://127.0.0.1:3000/auth/auth0/callback", "http://127.0.0.2:3000/auth/auth0/callback", "http://localhost:3000/auth/auth0/callback", "http://localhost:8080/auth/auth0/callback", "https://*.dev.cloudnativedays.jp/auth/auth0/callback", "http://localhost:8089/auth/auth0/callback", "http://localhost:8080/cndw2025/ui", "http://localhost:8089/cndw2025/ui", "http://localhost:8089"]
  cross_origin_auth                   = "false"
  custom_login_page_on                = "true"
  grant_types                         = ["authorization_code", "client_credentials", "implicit", "refresh_token"]
  is_first_party                      = "true"
