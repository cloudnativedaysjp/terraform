...
resource "aws_iam_role_policy_attachment" "ecs-seaman-ssm" {
  role       = aws_iam_role.ecs-seaman.name
  policy_arn = data.aws_iam_policy.AmazonSSMManagedInstanceCore.arn
}
...
resource "aws_iam_role_policy_attachment" "ecs-post-registration-ssm" {
  role       = aws_iam_role.ecs-post-registration.name
  policy_arn = data.aws_iam_policy.AmazonSSMManagedInstanceCore.arn
}
...
resource "aws_iam_role_policy_attachment" "ecs-medialive-alert-ssm" {
  role       = aws_iam_role.ecs-medialive-alert.name
  policy_arn = data.aws_iam_policy.AmazonSSMManagedInstanceCore.arn
}

resource "aws_iam_role_policy_attachment" "ecs-medialive-alert-medialive" {
  role       = aws_iam_role.ecs-medialive-alert.name
  policy_arn = data.aws_iam_policy.AWSElementalMediaLiveFullAccess.arn
}
